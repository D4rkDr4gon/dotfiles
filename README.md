...
Entorno de trabajo personalizado con estética cyberpunk, optimizado para pentesting y desarrollo. Basado en Qtile + Polybar + Kitty + Zsh, con sistema de temas dinámicos y flujo de trabajo 100% controlado por teclado.
...
| [Instalacion](docs/installation.md) | Guia de instalacion desde cero |
| [Atajos de Teclado](docs/keybindings.md) | Todos los shortcuts, aliases y bindings |
| [Sistema de Temas](docs/themes.md) | Temas dinamicos, colores y switching |
| [Automatizaciones](docs/automations.md) | Scripts de instalacion y automatizacion |
